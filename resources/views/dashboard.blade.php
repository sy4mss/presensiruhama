                                ...
                                <div class="presencecontent">
                                    <div class="iconpresence">
                                        @if ($presensihariini !== null)
                                            @php
                                                $path = Storage::url(
                                                    'private/public/upload/absensi' . $presensihariini->foto_in,
                                                );
                                            @endphp
                                ...
                                <div class="presencecontent">
                                    <div class="iconpresence">
                                        @if ($presensihariini !== null && $presensihariini->jam_out !== null)
                                            @php
                                                $path = Storage::url(
                                                    'private/public/upload/absensi' . $presensihariini->foto_out,
                                                );
                                            @endphp
                                            <img src="{{ url($path) }}" alt="" class="imaged w64">
                                        @else
                        ...
                        <div class="card">
                            <div class="card-body text-center"style="padding: 16px 12px !important; line-height:0.8rem ">
                                ...
                                <ion-icon name="accessibility-outline"
                                    style="font-size:1.6rem;"class="text-primary"></ion-icon>
                                <br>
                                <span style ="font-size:0.8rem; font-wight:500">Hadir</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center"style="padding: 16px 12px !important; line-height:0.8rem ">
                                ...
                                <br>
                                <span style ="font-size:0.8rem; font-wight:500">Izin</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center"style="padding: 16px 12px !important; line-height:0.8rem ">
                                ...
                                <br>
                                <span style ="font-size:0.8rem; font-wight:500">Sakit</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body text-center"style="padding: 16px 12px !important; line-height:0.8rem ">
                                ...
                                <br>
                                <span style ="font-size:0.8rem; font-wight:500">Telat</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="listview image-listview">
                                <li>
                                    @foreach ($historibulanini as $d)
                                        @php
                                            $path = Storage::url('public/upload/' . $d->foto_in);
                                        @endphp
                                <li>
                                    <div class="item">
